...
// New returns a new instance of a CoreTracker. It will use db for persistency and the provided unpacker to unpack
// addresses stored in the database.
func New(db *db.Database, unpacker AddrUnpacker) (*CoreTracker, error) {
