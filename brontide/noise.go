...
var (
	...
	// astralPrologue is the noise prologue that is used to initialize
	// the brontide noise handshake.
	astralPrologue = []byte("astral")
...
func ecdh(pub *btcec.PublicKey, priv SingleKeyECDH) ([]byte, error) {
...
type handshakeState struct {
	...
	localStatic    SingleKeyECDH
	localEphemeral SingleKeyECDH // nolint (false positive)
...
func NewBrontideMachine(initiator bool, localKey SingleKeyECDH,
	...
	handshake := newHandshakeState(
		initiator, astralPrologue, localKey, remotePub,
	)
